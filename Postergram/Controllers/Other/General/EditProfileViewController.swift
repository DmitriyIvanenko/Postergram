...
final class EditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    private func createTableHeaderView() -> UIView {
        let header = UIView(frame: CGRect(x: 0,
                                          y: 0,
                                          width: view.widthExt,
                                          height: view.heightExt/4).integral)
        let size = header.heightExt/1.5
        let profilePhotoButton = UIButton(frame: CGRect(x: (view.widthExt-size)/2,
                                                        y: (header.heightExt-size)/2,
                                                        width: size,
                                                        height: size))
    ...
    @objc private func didTapChangeProfilePicture() {
        let actionSheet = UIAlertController(title: "Profile Pricture",
